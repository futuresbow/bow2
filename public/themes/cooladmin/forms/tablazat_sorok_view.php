            ...
            <div class="box-item scrollable">
                ...
                <div class="scrollable-container">
                    ...
                    <div class="scrollable-item">
                        ...
                        <table class="table table-borderless table-striped " id="<?= $sortableId;?>">
						<thead class="thead-dark">
                            <tr > <!-- + class="items-selected" if there's selected items -->
                                <th class="chk-column">
								#
                                </th>
						...
						<tbody>
                            ...
                            <tr data-id="<?= $sor->id; ?>">
								<td scope="row" style="<?= (isset($sor->mezoSzin))?' background:'.$sor->mezoSzin:''?>">
                                    <?= $sor->id;?>
                                </td>
                                <?php foreach($megjelenitettMezok as $k => $felirat):?>
